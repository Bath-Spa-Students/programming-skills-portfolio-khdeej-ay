'''A girl wants to buy USBs for £50. They are for £6 each.
Write a programme that calculates how many USBs she can buy and 
...
# used remainder operator to get the remaining amount
change = 50 % 6
